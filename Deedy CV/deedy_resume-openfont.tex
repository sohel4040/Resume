...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Sohel}{Bargir}{ \urlstyle{same}\href{http://debarghyadas.com}{debarghyadas.com}| \href{http://fb.co/dd}{fb.co/dd}\\
\href{mailto:deedy@fb.com}{sohelbargir2@gmail.com} | 607.379.5733 | \href{mailto:dd367@cornell.edu}{dd367@cornell.edu}
}o
...
\subsection{COEP Technological University}
\descript{B.Tech in Computer Science}
\location{Expected July 2025 | Pune, India}
\sectionsep

\subsection{Government Polytechnic Miraj}
\descript{Diploma in Computer Science}
\location{June 2022 | Sangli, India}
\location{ Cum. GPA: 3.83 / 4.0 \\
Major GPA: 3.9 / 4.0}
\sectionsep

\subsection{Adarsh Shikshan Mandir}
\location{May 2019|  Sangli, India}
\sectionsep
